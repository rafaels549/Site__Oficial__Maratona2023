      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-body menu2">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item"> 
              <a class="nav-link" href="pag_inscricao/inscricao.html">
              ...
              <li class="nav-item">
                <a class="nav-link" href="pag_programacao/programacao.html"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                  <path fill="#15457A"
                ...
                <li class="nav-item" >
                  <a class="nav-link linguagens" href="pag_linguagens_de_programacao/linguagens_de_programacao.html"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                      <path fill="#15457A"
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pag_contato_e_local/contato_e_local.html">
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                        <path fill="#15457A"
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="pag_sobre_nos/sobre_nos.html">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
